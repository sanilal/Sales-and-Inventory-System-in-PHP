...
?>  
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Customer : <?php
					$br_res=mysqli_fetch_object(mysqli_query($url,"select * from `".TB_pre."brands` WHERE `brand_id`=".$_GET['brand_id']));
            ...
            <div class="box-body">
				...
				<form id="product-selling" name="product-selling" action="sell-product-action.php">
                  <table class="table table-bordered table-hover">
					...
					$i = 1;
					 ?>
                      ...
                      <td>
						  <input type="number" disabled name="available-stock<?php echo $pr_res->product_id; ?>" id="available-stock<?php echo $pr_res->product_id; ?>" value="<?php echo $pr_res->stocks; ?>" class="available-stock" />
							<!--<strong style="font-size: 20px; color: #16bb02;" class="available-stock"><?php echo $pr_res->stocks; ?></strong>-->
						  </td>
                        <td>
							 <input type="number" placeholder="Enter quantity" name="stock" id="stock" required />
   ...
   <?php include_once('includes/footer-scripts.php'); ?>
	...
	$(document).ready(function(){
		...
		$('#product-selling input[type="submit"]').click(function(){
			var available_stock=$('#product-selling .available-stock').text();
