 ...
 while($row = mysqli_fetch_array($result))
 {
  ...
  $product = mysqli_fetch_array($productresult);
	...
	$purchasetresult = mysqli_query($url, $purchaset_query);
	  while($currentpuresult = mysqli_fetch_array($purchasetresult))
	  {
		  
	  
	//$purchasetrr = mysqli_fetch_array($purchasetresult);
	$purchasetno = $currentpuresult['purchase_no'];
	$supplierName=$row["supplier_id"];
	  
	/*$purchasemastert_query="
	  SELECT * FROM `".TB_pre."purchase_master` WHERE `purchase_no`=$purchasetno
	 ";
	...
	$supplier_query="
  SELECT * FROM `".TB_pre."brands` WHERE `brand_id`=$supplierName";
	 print_r($supplier_query);
	}	 
