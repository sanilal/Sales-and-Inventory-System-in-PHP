...
<?php  
 if(isset($_REQUEST['btnadd'])){
	...
	if($procatname!=""){
	  ...
	  $num=mysqli_num_rows(mysqli_query($url,"SELECT `cat_name` FROM `".TB_pre."pcategories` WHERE `cat_name`='$procatname' && `parent_cat`='$parent' "));
	  //var_dump($num); exit;
	  if($num < 1){
		  $g_images="";
		...
		//var_dump($g_images); exit;
		  ...
		  $query = "INSERT INTO `".TB_pre."pcategories` (`cat_name`,`parent_cat`,`cat_banner`, cat_desc, cat_imgs, cat_videos) VALUES('$procatname','$parent','$p_image','".$_POST['cat_desc']."', '".$g_images."', '".$cat_videos."')";
            ...
            <div class="box-body">
              <form role="form" method="post"  class="form-horizontal" action="" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Product Category" name="productmenu" id="productmenu">
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <?php
					  $r_p=mysqli_query($url,"select * from `".TB_pre."pcategories` WHERE parent_cat=0");
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" placeholder="Product Category" name="cat_desc" id="catdesc"></textarea>
                    </div>
