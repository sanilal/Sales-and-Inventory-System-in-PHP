 ...
 if(isset($_REQUEST['btnadd'])){
	...
	if($brand!="" && $_POST['model']!=""){
		...
		//
		  ...
		  //var_dump($num); exit;
		  $query = "INSERT INTO `".TB_pre."brand_model_series` (`series_name`, `model_id`, `series_desc`,`series_img`) VALUES('".$_POST['model']."', '$brand', '$desc', '$b_image' )";
		  //var_dump($query); exit;
              ...
              <form role="form" method="post"  class="form-horizontal" action="" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Series Name" name="model" id="brand-model" />
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary" name="btnadd">Add Series</button>
                  </div>
                </form>
            </div><!-- /.box-body -->
