...
$sql="select * from `".TB_pre."brands` ORDER BY `brand_name` ASC ";
...
?>  
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="add-brand.php" class="btn btn-block"><i class="fa fa-plus"></i> Add Contact</a></li>
          </ol>
					...
					while($res = mysqli_fetch_array($r1)){ ?>
                      ...
                      <?php // } else{ echo "No-image";} ?>-->
                        ...
                        <td><?php echo $res['brand_name']; ?></td>
					  	<td><a href="view-brand.php?brand_id=<?php echo $res['brand_id']; ?>" class="btn btn-warning" style="width:100px; float: right;">Details</a></td>
                        <td><a href="edit-brand.php?brand_id=<?php echo $res['brand_id']; ?>" style="width:100px;" class="btn btn-primary" title="">Edit</a></td>
