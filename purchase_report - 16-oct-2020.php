...
<tr>
  ...
  <td>&nbsp;</td>
	...
	<tr>
		...
		<td><?php echo round((($unit_price*$res->quantity)*($res_pur->shipping/100))/$res->quantity, 2); ?></td>
		<!--<td><?php //echo round((($res_pur->customs)/$total_quantity[0])*$res->quantity, 2); ?></td>-->
		<td><?php echo round((($unit_price*$res->quantity)*($res_pur->customs/100))/$res->quantity, 2); ?></td>
		<!--<td><?php //echo round((($res_pur->handling)/$total_quantity[0])*$res->quantity, 2); ?></td>-->
		<td><?php echo round((($unit_price*$res->quantity)*($res_pur->handling/100))/$res->quantity, 2); ?></td>
